        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPU = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    RAM = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Storage = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    GPU = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Screen = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
